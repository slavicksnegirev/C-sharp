...
namespace lab_1_1
{
    public class EarlGrey
    {
        ...
        public EarlGrey(string name = "Earl Grey", string countryProducer = null, bool bergamot = false, double volume = 0, int seconds = 0, int minutes = 0, int hours = 0, int day = 0, int month = 0, int year = 0, int choice = 0)
        {
            _name = name;
        ...
        public EarlGrey(string name, bool bergamot)
        {
            _name = "No name";
            _bergamot = bergamot;
        }
        ...
        // статический метод
        public static void FiveOClock()
        {
            Console.WriteLine("\nВремя пить чай Earl Grey!");
        }
